...
class EntryContent extends StatefulWidget {
  const EntryContent({super.key, required this.entry_id});

  final String entry_id;

  @override
  State<EntryContent> createState() => _EntryContentState();
}

class _EntryContentState extends State<EntryContent> {
